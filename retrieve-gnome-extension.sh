...
GNOME_SHELL_EXTENSION_ID_LIST=`cat gnome_shell_extensions_id.txt | sed -e "s/:.*//g" | tr "\n" " "`
...
then
	...
	GNOME_SHELL_EXTENSION_UUID_LIST=`cat gnome_shell_extensions_id.txt | sed -e "s/^.*://g" | tr "\n" " "`
